...
public class UserProfileControllers {
    ...
    @PostMapping("/add")
    public Result add(UserProfile userProfile) { return userProfileService.add(userProfile);}

    @PostMapping("/update")
    public Result update(UserProfile userProfile){return userProfileService.update(userProfile);}

    @GetMapping("/getall")
    public DataResult<List<UserProfile>> getAll(){return userProfileService.getAll();}

    @GetMapping("/getbyid")
    public DataResult<UserProfile> getById(int id){return  userProfileService.getById(id);}
